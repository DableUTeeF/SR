...
if __name__ == '__main__':
    ...
    for epoch in range(opt.nEpochs):
        ...
        for i, data in enumerate(dataloader):
            ...
            discriminator_loss = adversarial_criterion(discriminator(high_res_real),
                                                       target_real) + adversarial_criterion(
                discriminator(Variable(high_res_fake.data)), target_fake)
